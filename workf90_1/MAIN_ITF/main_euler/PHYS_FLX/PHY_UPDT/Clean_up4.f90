...
! The current code deals only stack of two discontinuity cells.	 
...
! stacked grid cell.
    ...
    or_x_velo=x_velocity(ordin_state+temp_m%p_cell%or_state)
    or_y_velo=y_velocity(ordin_state+temp_m%p_cell%or_state)    
    or_pressure=l_area*l_pressure+m_area*m_pressure+r_area*r_pressure
    inteng_s=l_area*inteng_l+m_area*inteng_m+r_area*inteng_r+inteng_m
    inteng_or=inteng_or+internal_energy(temp_m%p_cell%or_state)
    or_pressure=or_pressure*inteng_or/inteng_s
