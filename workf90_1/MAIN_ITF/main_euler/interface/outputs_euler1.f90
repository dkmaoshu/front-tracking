...
write(1,'(4f20.12)')  &
(((uu(i,j)%value(k),k=1,4),i=nxll-3,nxll+nx+2),j=nyll-3,nyll+ny+2)
write(1,'(4f20.12)')  &
((uu(i,j)%gamma,i=nxll-3,nxll+nx+2),j=nyll-3,nyll+ny+2)
...
write(7,'(2a12)') boundary_type_1, boundary_type_2
if(boundary_type_1.eq.'periodic    ') write(7,'(f18.12)') moved_time
close(7)
