...
select case(p_cell%wv_nb)
 ...
 case(2)
  call find_physical_state(uu_l,normal,phys_l)
  call find_physical_state(uu_r,normal,phys_r)
  speed=0.5d0*(phys_l%value(2)+phys_r%value(2))
 case default; call error_message
end select   
