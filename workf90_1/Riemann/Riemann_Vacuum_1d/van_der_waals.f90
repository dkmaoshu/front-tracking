...
c=(gamma-1.0d0)*(u%csq%value(3)-0.5d0*u%csq%value(2)**2.d0 & 
  /u%csq%value(1)+a*u%csq%value(1)**2.0d0)/(1.0d0-b*u%csq%value(1)) &
  -a*u%csq%value(1)**2.0d0
...
c=dlog((pf(u)+a*u%csq%value(1)**2.0d0)* &
  ((1.0d0-b*u%csq%value(1))/u%csq%value(1))**gamma)  
