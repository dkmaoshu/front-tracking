...
do while(associated(temp).and.head_switch) 
 ...
 select case(temp%partner)
  ...
  case('single  ')
   ...
   p_cell%or_state=p_cell%or_state-0.5d0*r*f_cell%numerical_regularization(2)
   p_cell%or_state=p_cell%or_state+0.5d0*r*temp%previous%f_cell%numerical_regularization(2)
  ...
  case('previous')
   ...
   p_cell%or_state=p_cell%or_state-0.5d0*r*f_cell%numerical_regularization(2)
   p_cell%or_state=p_cell%or_state+0.5d0*r*temp%previous%previous%f_cell%numerical_regularization(2)
   p_cell%or_state=p_cell%or_state+0.5d0*r*temp%next%f_cell%numerical_regularization(1)

  case('next    ')
   p_cell%or_state=p_cell%or_state-0.5d0*r*f_cell%numerical_regularization(1)
   p_cell%or_state=p_cell%or_state-0.5d0*r*temp%next%f_cell%numerical_regularization(2)
   p_cell%or_state=p_cell%or_state+0.5d0*r*temp%previous%f_cell%numerical_regularization(2)
   p_cell%or_state=p_cell%or_state+0.5d0*r*temp%next%next%f_cell%numerical_regularization(1)
