program Haas_Sturtevant_He_air

! Haas-Sturtevant shock-bubble interaction experiments, air-helium case. 
...
nxll=-7*nn; nyll=-nn; nx=14*nn+1; ny=2*nn+1
x_width=6.23d0; y_width=0.89d0
...
end program Haas_Sturtevant_He_air
