...
!the time of the shock to reach the interface is 0.038085168.
...
xposi=dfloat(ii)*h; yposi=dfloat(jj)*h
...
rhom=1.225d0;  um=0.2d0;       vm=0.0d0; pm=1.01325d0; gammam=1.4d0
call tran3(rhom,um,vm,pm,wwm,gammam)
...
rhob=3.8635d0;  um=0.2d0; vm=0.0d0; pm=1.01325d0;  gammab=1.249d0
call tran3(rhob,um,vm,pm,wwb,gammab)
